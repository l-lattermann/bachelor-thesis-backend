...
class RcCubeGrpcClient:
    ...
    def test_disparity(self, **kwargs):
        print("=== RC-CUBE TEST ===")
        print("IP:", self.rc_cube_ip)
        ...
        req = pb2.ImageSetRequest(**kwargs)

        print("Request params:", kwargs)

        try:
            msg = next(stub.StreamImageSets(req, timeout=self.timeout))
            ...
            if msg.HasField("left"):
                l = msg.left
                print("LEFT OK:", l.width, l.height, l.encoding, len(l.data))
            else:
                print("LEFT MISSING")
            ...
            if msg.HasField("disparity"):
                ...
                print("DISP OK:",
                    ...
                    d.image.encoding, len(d.image.data))
            else:
                print("DISP MISSING")
